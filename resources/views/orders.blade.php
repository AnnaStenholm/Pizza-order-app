    ...
    <header>
      <h1>PIZZA-KING</h1>
        ...
        <div class="container pt3">
          <div class="heading"><h1 class="heading-content">Köket-ordrar</h1></div>
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Pizza: {{$Order->name}}</p>
                  <div class="kitchen">
                    <div class="vertical-center">
                  <form action="" class="form-kitchen" method="POST">
                    @csrf
                    <input type="hidden" name="OrderId" value="{{$Order->OrderId}}"/>
                  <button type="submit" class="button-kitchen">
                    @switch ($Order->Status)
                  @case(0)
                  Tillaga
                  @break
